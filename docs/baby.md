...
|Cosleeper | Optioneel | Ja | Een coosleeper is een soort bedje dat op hoogte instelbaar is en naast je bed (op klossen) kan staan. Dat is mega handig als je snachts wilt voeden of er ff een speen in wil doen als ie loopt te huilen |
...
|Nestje| Optioneel | Nee | Een babynestje is een soort kussen waarin je baby lekker veilig kan liggen. Mega handig, kost je niks. Ook handig bij visite, je kan overal je baby ff kwijt. Baby slaapt er ook goed in.|
|Hydrofielen x10|Ja|||
|Luieremmer|Ja|||
|Commode|Ja|||
|Verschoonkussen|Ja|||
